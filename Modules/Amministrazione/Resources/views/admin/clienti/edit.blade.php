                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('amministrazione::admin.clienti.partials.fields', ['lang' => $locale])
                            @include('amministrazione::admin.clienti.partials.indirizzi_list', ['lang' => $locale])
                            @include('amministrazione::admin.clienti.partials.referenti_list', ['lang' => $locale])
                            @if($cliente->pa == 1)
                                @include('amministrazione::admin.clienti.partials.ambienti', ['lang' => $locale])
                            @endif
                    ...
                    <div class="box-footer">
                        ...
                        <a class="btn btn-info pull-left btn-flat" href="{{ route('admin.amministrazione.clienti.read', [$cliente->id])}} "><i class="fa fa-arrow-left"></i> vai a visualizzazione </a>
                        ...
                        @endif
                       	<button type="button"  class="btn btn-danger btn-flat pull-right mr-1 " data-toggle="modal" data-target="#modal-delete-confirmation" data-action-target="{{ route('admin.amministrazione.clienti.destroy', [$cliente->id]) }}"><i class="fa fa-trash"></i> {{ trans('core::core.button.delete') }}</button>
