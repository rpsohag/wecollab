...
@section('content-header')
    <h1>
        {{ trans('assistenza::richiesteinterventi.title.create richiesteintervento') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('assistenza::richiesteinterventi.title.create richiesteintervento') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.assistenza.richiesteintervento.store'], 'method' => 'post', 'files'=> true]) !!}
    <div class="row">
        <div class="col-md-12">
