...
@section('content-header')
    <h1>
        {{ trans('assistenza::ticketinterventi.title.create ticketintervento') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('assistenza::ticketinterventi.title.create ticketintervento') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.assistenza.ticketintervento.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
